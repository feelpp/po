...
On a ensuite plus qu'à créer un espace de fonction de ce type, et récupérer deux éléments de cet espace, puis prendre les 3 composantes de ces éléments.
...
\lstinputlisting[firstline=83, lastline=86]{../../src/mode_gen_curl.cpp}
...
\lstinputlisting[firstline=87, lastline=87]{../../src/mode_gen_curl.cpp}
...
\lstinputlisting[firstline=89, lastline=92]{../../src/mode_gen_curl.cpp}
