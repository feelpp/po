...
$(\lambda_i,\mathbf{g_i})$ & $\rott  \mathbf{g_i} = \Lambda_i \mathbf{g_i}$ & $\DD^1$ \\ \hline
$\mathbf{\mathbf{g_i}^0}$ & $\grad(\diverg \mathbf{\mathbf{g_i}^0}) - \laplace \mathbf{\mathbf{g_i}^0} = \Lambda_i \mathbf{g_i}$ & $\HH^1_0$\\ \hline
...
\begin{align*}
\int_\Omega (\rot \mathbf{b})(\rot\bm{\varphi}) &- \int_{\partial\Omega} (\rot \mathbf{b})(\bm{\varphi}\cdot n) \\
&+\int_\Omega \psi_1(\diverg\bm{\varphi}) - \int_{\partial\Omega} \psi_1(\bm{\varphi}\cdot n) = 0
\end{align*}
\end{block}
\begin{columns}[t]
\begin{column}{5cm}
