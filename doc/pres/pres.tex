...
%% add frame for the steps to change the basis with code
%% add profile before/after (spy)
...
\begin{frame}{Results}
  \begin{figure}[H]
    \makebox[\textwidth][c]{
      \subfloat[mode 0]{\includegraphics[scale=0.15]{sphMode0}}\ 
...
\begin{frame}{Perspectives}
  ...
  %% Zh as a basis, scalability, timing, interfaced, ...
