...
\begin{figure}[H]
	\makebox[\textwidth][c]{
		...
		\subfloat[mode 5]{\includegraphics[scale=0.3]{curl-grad-1e3-mode20}}
	}\\
	\makebox[\textwidth][c]{
		\subfloat[mode 10]{\includegraphics[scale=0.3]{curl-grad-1e3-mode30}}\ 
		\subfloat[mode 14]{\includegraphics[scale=0.3]{curl-grad-1e3-mode45}}
	}
...
De plus, en regardant les deux champs, on voit qu'ils n'ont pas la même forme. Par exemple, la figure \ref{eigendiff} montre la différence entre le $10^{ème}$ vecteur propre et son rotationnel :
