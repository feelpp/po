...
\begin{figure}[H]
\makebox[\textwidth][c]{
  \subfloat[$\rot$ avec Lagrange d'ordre 2]{\label{curlO2H1}\includegraphics[scale=0.5]{curlO2H1}}\ 
  \subfloat[$\rott$ avec Lagrange d'ordre 2]{\label{curl2O2H1}\includegraphics[scale=0.5]{curl2O2H1}}
}\\
\makebox[\textwidth][c]{
  \subfloat[$\rot$ avec Lagrange d'ordre 3]{\label{curlO3H1}\includegraphics[scale=0.5]{curlO3H1}}\ 
  \subfloat[$\rott$ avec Lagrange d'ordre 3]{\label{curl2O3H1}\includegraphics[scale=0.5]{curl2O3H1}}
}\\
\makebox[\textwidth][c]{
  \subfloat[$\rot$ avec Nedelec]{\label{curlNed}\includegraphics[scale=0.5]{curlNed}}\ 
  \subfloat[$\rott$ avec Nedelec]{\label{curl2Ned}\includegraphics[scale=0.5]{curl2Ned}}
}
