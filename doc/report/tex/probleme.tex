...
\node[draw,scale=\taille,fill=gray!50,label={[xshift=1.0cm](\ref{pbeigen})}] (pbeigen) at (13,2)
{$\begin{aligned}
\rott \mathbf{g_i} = \Lambda_i\mathbf{g_i}\\
\mathbf{g_i}\cdot \mathbf{n}\restr = 0\\
\rot \mathbf{g_i}\cdot \mathbf{n}\restr = 0\\
\rott \mathbf{g_i}\cdot \mathbf{n}\restr = 0
\end{aligned}$} ;
\node[draw,scale=\taille,fill=yellow!50] (lambda) at (12,-1) {$\Lambda_i$} ;
\node[draw,scale=\taille,fill=yellow!50] (gi) at (13,-1) {$\mathbf{g_i}$} ;
\node[draw,scale=\taille,fill=gray!50,label={[xshift=1.3cm](\ref{gi0})}] (pbgi0) at (15,-3)
{$\begin{aligned}
\grad(\diverg \mathbf{g_i^0})-\laplace \mathbf{g_i^0} = \Lambda_i\mathbf{g_i}\\
\mathbf{g_i^0}\restr = 0
\end{aligned}$} ;
\node[draw,scale=\taille,fill=yellow!50] (gi0) at (15,-4.5) {$\mathbf{g_i^0}$} ;
\node[draw,scale=\taille,fill=gray!50,label={[xshift=0.8cm](\ref{psi})}] (pbpsi) at (15,-6)
{$\begin{aligned}
-\laplace\psi_i = \diverg \mathbf{g_i^0}\\
\grad\psi_i\cdot \mathbf{n}\restr = 0
\end{aligned}$} ;
\node[draw,scale=\taille,fill=yellow!50] (psi) at (15,-7.5) {$\psi_i$} ;
...
\draw[->,>=latex,cyan] (lambda) -- (pbb.20);
\draw[->,>=latex,cyan] (gi) -- (pbb.15);
...
\draw[->,>=latex] (a2) -- (pbs);
\draw[->,>=latex] (ck0) -- (pbs);
\draw[->,>=latex] (lambda) -- (pbs.45);
\draw[->,>=latex] (gi) -- (pbs.40);
\draw[->,>=latex] (psi) -- (pbs);
\draw[->,>=latex] (pbs) -- (ck);
\draw[->,>=latex] (ck) -- (pbu);
\draw[->,>=latex] (pbu) -- (u);
